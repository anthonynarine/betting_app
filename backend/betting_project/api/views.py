...
class GroupViewset(viewsets.ModelViewSet):
    ...
    def join(self, request, pk=None):
        ...
        """
        user = request.user  #The request.user attribute is populated by Django's authentication middleware, and it typically contains an instance of the authenticated user. 
    ...
    def leave(self, request, pk=None):
        ...
        try:
            ...
            member.delete()
            return Response({"message:" "Successfuly left the group"}, status=status.HTTP_200_OK)
