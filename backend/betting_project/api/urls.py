from api.views import bet_views, group_views, member_views, event_views, participants_views
...
router.register("participants", participants_views.ParticipantViewSet, basename="participant") 
